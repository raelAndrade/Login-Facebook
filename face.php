...
$fb = new \Facebook\Facebook([
  'app_id' => '265003130676857',
  'app_secret' => '169fcd43e1744caba5606123e31b5c43',
...
if (! isset($accessToken)) {
	$url_login = 'http://localhost/app-login-facebook/face.php';
	...
	try {
		...
		$user = $response->getGraphUser();
	  	...
	  	$result_usuario = "SELECT id, nome, email, senha FROM usuarios WHERE email='".$user['email']."' LIMIT 1";
